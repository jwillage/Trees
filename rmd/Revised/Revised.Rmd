...
for (i in 1:87) { # ~63K trees in Manh + various trees from BK, Qns, Bx that are in the box = 87K
...
Next, the trees are subset to just those in Manhattan. The first step is to retrieve a shape file describing Manhattan.     
